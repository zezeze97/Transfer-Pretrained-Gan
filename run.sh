...
#srun --job-name=base-save-autoshift -p GPU --nodes 1 --gres=gpu:1 --cpus-per-task 6 --qos low --time 120:00:00 \
...
srun --job-name=nB-sas -p GPU --nodes 1 --gres=gpu:1 --cpus-per-task 6 --qos low --time 120:00:00 \
